...
\node[process, right=of start] (rufus) {使用 Univeral-USB-Installer\\烧录备份镜像至 U 盘};
\node[process, right=of rufus] (flag) {J1900不需要设置BACKUP\_ROOTFS标志文件};
...
{生成备份目录\\gns-rootfs-backup-XXXXXX-googoltech};
